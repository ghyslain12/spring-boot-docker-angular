...
public class GlobalExceptionHandler {
    ...
    // Gestion des exceptions RuntimeException (ex. "User not found")
    ...
    // Gestion des IllegalArgumentException (ex. "Password cannot be null")
    ...
    // Gestion globale des autres exceptions inattendues
